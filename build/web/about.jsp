<%-- 
    Document   : about
    Created on : Oct 23, 2021, 10:00:57 AM
    Author     : ADMIN
--%>
                            ...
                            <nav class="navigation navbar navbar-expand-md navbar-dark ">
                                ...
                                <div class="collapse navbar-collapse" id="navbarsExample04">
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <form action="About" method="post" class="nav-item active">
            ...
            <div class="row d_flex">
               ...
               <div class="col-md-7">
                  <div class="titlepage">
                     ...
                     <p>a company associated with nippon paint since 2011. The company is located in the northern region, and headquartered in the center of Bac Giang city.</p>
                  </div>
               </div>
            </div>
         </div>
