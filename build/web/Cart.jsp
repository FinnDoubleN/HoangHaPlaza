                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                            <div class="glasses_box">
                                <figure><img class="img-cart"
                                             src="<%= c.getProductPath()%>"></figure>
                                <h3>Total: <%= format.format(c.getItemQuantity() * c.getProductPrice())%><br></h3>
                            ...
                            Total Cost (<%= cart.size()%> Products): <label style="font-size: 120%"><strong>
                                    <%
                                        ...
                                        for (int i = 0; i < cart.size(); i++) {
                                            double price = cart.get(i).getItemQuantity() * cart.get(i).getProductPrice();
                                            total = total + price;
                                        }
