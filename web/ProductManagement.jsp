<%-- 
    ...
    Created on : Nov 4, 2021, 5:56:59 PM
    Author     : ADMIN
--%>
                    ...
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <form action="CategoryManagement" method="post" class="nav-item">
                                    <button name="username" class="btn btn-success" style="background-color: #435d7d;">Category</button>
                                </form>
                            </div>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><%= c.getColorID()%></td>
                                <td>
                                    <form action="Shop" method="post" class="shop-button">
                                    <button name="edit" value="<%= c.getPid()%>" class="shop-button-buy"data-toggle="modal">Edit</button>
                                    <button name="delete" value="<%= c.getPid()%>" class="shop-button-buy"data-toggle="modal">Delete</button>
                                    </form>
                                </td>
                            </tr><%}%>
                        </tbody>
